...
*/
  ...
  blackShape.add(blackRow2.draw()), .1);
  blackShape.add(blackRow3.draw()), .1);
  blackShape.add(blackRow4.draw()), .1);
  blackShape.add(blackCol0.draw()), .1);
  blackShape.add(blackCol1.draw()), .1);
  blackShape.add(blackCol2.draw()), .1);
  blackShape.add(blackCol3.draw()), .1);
  blackShape.add(blackCol4.draw()), .1);
